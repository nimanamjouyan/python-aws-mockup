...
class Model(BaseModel):
    ami_id: str = Field(default="ami-00399ec92321828f5", title="The ami id of the instance")
    aws_access_key_id: str = Field(..., title="The aws access key id")
    aws_secret_access_key: str = Field(..., title="The aws secret key")
    region_name: str = Field(default="us-east-2", title="The region name of the instance")
